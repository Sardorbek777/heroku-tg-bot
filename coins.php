<?php
ob_start();
define("uzfox","5588751787:AAGmbia_0Tej_PSzXFjjLK-vyYaD-0dZJM8");
$admin = "497229452";
$botname = "Cash Tashkent";
...
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/DizaynerKamron"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/Narxxlar"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/hdand4kfon"],],
...
function phonenumber($id){
     ...
     uzfox("sendPhoto",[
    "chat_id"=>$id,
"photo"=>"https://t.me/ALISHER20020221/16",
...
<pre>[💣BOT🎩DASTURCHISI👑+https://t.me/DASTURCHI_YIGIT]\n[📈Yangiliklar🔦+https://t.me/xabarchilar]</pre>",
"parse_mode"=>"html",
                      "disable_web_page_preview"=>true,
                    ]);
...
uzfox("sendPhoto",[
    "chat_id"=>$chatid,
"photo"=>"https://t.me/ALISHER20020221/10",
    "caption"=>"✅ <b>Pul_Tolanadi_isbot tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
uzfox("sendPhoto",[
"chat_id"=>$chatid,
"photo"=>"https://t.me/ALISHER20020221/11",
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/Pul_Tolanadi_isbot"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/Boom_Payn"],],
]
]),
]);
}
...
"disable_web_page_preview"=>true,
"parse_mode"=>"html",
"message_text"=>"✅ <b>Pul_Tolanadi_isbot tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
uzfox("sendPhoto",[
"chat_id"=>$chatid,
"photo"=>"https://t.me/ALISHER20020221/9",
...
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"Nima haqida yozmoqchisiz? 😊\n\n<b>📞 Aloqa markazi:</b> @Pul_Tolanadi_isbot",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/Pul_Tolanadi_isbot"],],
]
]),
]);
}
...
uzfox("sendPhoto",[
"chat_id"=>$chatid,
"photo"=>"https://t.me/ALISHER20020221/13",
"caption"=>"<b>Bot dasturchisi:</b> <a href='tg://user?id=831477295'>👨‍💻ALISHER👨‍💻</a>\n\n<b>Ish vaqti: 07:00 dan 23:00 gacha</b>\n\n<b>Diqqat! Bot pul to'lab berish yoki to'lab bermasligiga dasturchi javobgar emas!</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"♻️ BOT📁YASATISH(ZAKAZ)👨‍💻🤖","url"=>"https://t.me/DASTURCHI_YIGIT"],],
]
]),
]);
}
